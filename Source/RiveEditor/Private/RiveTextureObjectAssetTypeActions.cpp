...
FRiveTextureObjectAssetTypeActions::FRiveTextureObjectAssetTypeActions(EAssetTypeCategories::Type InAssetCategory)
...
FText FRiveTextureObjectAssetTypeActions::GetAssetDescription(const FAssetData& AssetData) const
{
...
void FRiveTextureObjectAssetTypeActions::OpenAssetEditor(const TArray<UObject*>& InObjects, TSharedPtr<IToolkitHost> EditWithinLevelEditor)
{
