...
#ifdef _EXPORTED_ENABLE_BINDLESS_TEXTURES
...
#ifndef _EXPORTED_FIXED_FUNCTION_COLOR_BLEND
                         ...
                         bool needsClipData)
{
    ...
    if (_EXPORTED_ENABLE_EVEN_ODD && (paintData.x & PAINT_FLAG_EVEN_ODD) != 0u)
    {
...
half4 blend(half4 srcColorUnmul, half4 dstColorPremul, ushort blendMode)
{
    ...
    if (_EXPORTED_ENABLE_ADVANCED_BLEND && blendMode != BLEND_SRC_OVER)
    {
...
#ifdef _EXPORTED_FIXED_FUNCTION_COLOR_BLEND
...
#ifdef _EXPORTED_ENABLE_CLIPPING // TODO! ENABLE_IMAGE_CLIPPING in addition to ENABLE_CLIPPING?
