...
#ifndef _EXPORTED_OPTIONALLY_FLAT
...
#define _EXPORTED_OPTIONALLY_FLAT
#endif
...
#ifdef _EXPORTED_PLS_IMPL_DEVICE_BUFFER

#define PLS_BLOCK_BEGIN                                                                             \
    struct PLS                                                                                     \
    {
#ifdef _EXPORTED_PLS_IMPL_DEVICE_BUFFER_RASTER_ORDERED
...
#define PLS_FRAG_COLOR_MAIN_WITH_IMAGE_UNIFORMS(NAME)                                               \
    PLS_FRAG_COLOR_METAL_MAIN(NAME,                                                                \
                              ...
                              FragmentTextures _textures,                                          \
                              FragmentStorageBuffers _buffers,                                     \
                              __VA_ARGS__ constant _EXPORTED_ImageDrawUniforms& imageDrawUniforms         \
                              [[buffer(IMAGE_DRAW_UNIFORM_BUFFER_IDX)]])
