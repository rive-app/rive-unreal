...
{
    return idBits == 0u ? .0 : unpackHalf2x16((idBits + MAX_DENORM_F16) * pathIDGranularity).x;
}
...
INLINE half4 premultiply(half4 color) { return make_half4(color.xyz * color.w, color.w); }
