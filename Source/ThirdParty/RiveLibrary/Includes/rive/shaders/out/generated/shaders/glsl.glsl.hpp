...
#if defined(_EXPORTED_USING_DEPTH_STENCIL) && defined(_EXPORTED_ENABLE_CLIP_RECT) && defined(GL_ES)
...
#ifdef _EXPORTED_PLS_IMPL_FRAMEBUFFER_FETCH
...
#define PLS_LOAD4F(PLANE)  PLANE
#define PLS_LOADUI(PLANE)  PLANE.x
#define PLS_STORE4F(PLANE, VALUE)  PLANE = (VALUE)
...
#ifndef _EXPORTED_TARGET_VULKAN
