...
FRiveRenderTarget(InRiveRenderer, InRiveName, InRenderTarget), RiveRenderer(InRiveRenderer)
{
}
...
DECLARE_GPU_STAT_NAMED(CacheTextureTargetRHI, TEXT("FRiveRenderTargetD3D11::CacheTextureTarget_RenderThread"));
