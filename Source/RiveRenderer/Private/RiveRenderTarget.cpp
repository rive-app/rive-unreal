...
UE::Rive::Renderer::Private::FRiveRenderTarget::FRiveRenderTarget(const TSharedPtr<FRiveRenderer>& InRiveRenderer, const FName& InRiveName, UTextureRenderTarget2D* InRenderTarget)
